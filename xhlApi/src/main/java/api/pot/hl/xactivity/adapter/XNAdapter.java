...
public class XNAdapter extends BaseAdapter {
    ...
    private final List<XNItemAdapter> mList;

    public XNAdapter(Context context, List<XNItemAdapter> list, List<Boolean> extraRemove, List<Integer> extra) {
        this.mList = list;
    ...
    @Override
    public XNItemAdapter getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        XNItemAdapter item = mList.get(position);
        ...
        if(item.offsetLeft>0){
            RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) holder.layoutDados.getLayoutParams();
            layoutParams.leftMargin = item.offsetLeft;
            holder.layoutDados.setLayoutParams(layoutParams);
        }
